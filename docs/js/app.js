...
class App {
    ...
    _mobileToggle(e) {
        ...
        if (toggleBtn && !header.children[2].classList.contains('is-open') || anchor) {
            header.children[1].insertAdjacentHTML('afterbegin', `<svg width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 1C0 0.447715 0.447715 0 1 0H19C19.5523 0 20 0.447715 20 1V3H0V1Z" fill="white"/><rect y="7" width="20" height="3" fill="white"/><path d="M0 14H20V16C20 16.5523 19.5523 17 19 17H1C0.447715 17 0 16.5523 0 16V14Z" fill="white"/></svg>`)
            document.querySelector('body').style.overflowY = ""
        } else {
            toggleBtn.insertAdjacentHTML('afterbegin', `<svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="20" height="3" rx="1" transform="matrix(0.735456 -0.677572 0.735456 0.677572 0 13.5515)" fill="white"/><rect width="20" height="3" rx="1" transform="matrix(0.735456 0.677572 -0.735456 0.677572 2.20642 0)" fill="white"/></svg>`)
